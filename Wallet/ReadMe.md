...
```
cargo run -- sign --share-id 1 --to 0x868263F7D8B5339655E7B3C9097c7b5149099AAf --amount 0.01

cargo run -- sign --share-id 2 --to 0x868263F7D8B5339655E7B3C9097c7b5149099AAf --amount 0.01
```
...
cargo run -- sign-round2 --share-id 1 --commitment-files commit_1_abcd.json commit_2_abcd.json
   ...
   cargo run -- sign-round2 --share-id 1 --commitment-files commit_1_ec346bf9.json commit_2_ec346bf9.json
   cargo run -- sign-round2 --share-id 2 --commitment-files commit_1_ec346bf9.json commit_2_ec346bf9.json
```
